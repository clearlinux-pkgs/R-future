...
Version  : 1.15.1
Release  : 26
URL      : https://cran.r-project.org/src/contrib/future_1.15.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/future_1.15.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1574701685
