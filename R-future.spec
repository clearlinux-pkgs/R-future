...
Version  : 1.18.0
Release  : 32
URL      : https://cran.r-project.org/src/contrib/future_1.18.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/future_1.18.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594307780
