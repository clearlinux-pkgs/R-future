...
Version  : 1.15.0
Release  : 24
URL      : https://cran.r-project.org/src/contrib/future_1.15.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/future_1.15.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1573231178
